...
program.name("createpr").description("Create a GitHub Pull Request from a Jira ticket").argument("<JIRA_TICKET>", "Example: LAN-3").action(async (JIRA_TICKET) => {
  ...
  try {
    ...
    const res = await fetch2(`${JIRA_BASE_URL}/rest/api/3/issue/${JIRA_TICKET}`, {
      headers: {
    ...
    const title = ((_a = response.fields) == null ? void 0 : _a.summary) || "";
    const description = ((_g = (_f = (_e = (_d = (_c = (_b = response.fields) == null ? void 0 : _b.description) == null ? void 0 : _c.content) == null ? void 0 : _d[0]) == null ? void 0 : _e.content) == null ? void 0 : _f[0]) == null ? void 0 : _g.text) || "";
    const teamFields = [
      (_i = (_h = response.fields) == null ? void 0 : _h.customfield_10001) == null ? void 0 : _i.name,
      (_j = response.fields) == null ? void 0 : _j.customfield_10001,
      (_l = (_k = response.fields) == null ? void 0 : _k.customfield_10037) == null ? void 0 : _l.value,
      (_n = (_m = response.fields) == null ? void 0 : _m.customfield_10038) == null ? void 0 : _n.value,
      (_q = (_p = (_o = response.fields) == null ? void 0 : _o.components) == null ? void 0 : _p[0]) == null ? void 0 : _q.name,
      (_s = (_r = response.fields) == null ? void 0 : _r.labels) == null ? void 0 : _s[0]
    ].filter(Boolean);
    let team = teamFields.length > 0 ? teamFields[0] : ((_u = (_t = response.fields) == null ? void 0 : _t.project) == null ? void 0 : _u.key) || "";
...
${description}`;
    ...
    try {
      ...
      const transitionsRes = await fetch2(`${JIRA_BASE_URL}/rest/api/3/issue/${JIRA_TICKET}/transitions`, {
        method: "GET",
        headers: {
          "Authorization": "Basic " + Buffer.from(`${JIRA_EMAIL}:${JIRA_API_TOKEN}`).toString("base64"),
          "Accept": "application/json"
      ...
      const inProgress = transitions.find((t2) => t2.name.toLowerCase() === "in progress");
      if (!inProgress) {
        ...
        const doTransitionRes = await fetch2(`${JIRA_BASE_URL}/rest/api/3/issue/${JIRA_TICKET}/transitions`, {
          method: "POST",
          headers: {
            "Authorization": "Basic " + Buffer.from(`${JIRA_EMAIL}:${JIRA_API_TOKEN}`).toString("base64"),
            "Accept": "application/json",
