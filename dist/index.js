...
program.name("createpr").description("Create a GitHub Pull Request from a Jira ticket").argument("<JIRA_TICKET>", "Example: LAN-3").action(async (JIRA_TICKET) => {
  try {
    if (!JIRA_TICKET) {
    ...
    console.log(`\u{1F50D} Fetching data for ${JIRA_TICKET} from Jira...`);
    ...
    console.log("\u{1F50D} Validating data obtained from Jira...");
    if (!title) {
    ...
    console.log(`\u{1F465} Team: ${team}`);
    console.log(`\u{1F33F} New branch: ${branchName}`);
    console.log("\u{1F504} Switching to develop and updating...");
    execSync(`git checkout develop`, { stdio: "inherit" });
    execSync(`git pull origin develop`, { stdio: "inherit" });
    console.log(`\u{1F6A7} Creating new branch: ${branchName}`);
...
${description}`;
    ...
    try {
      console.log(`\u{1F504} Attempting to move Jira ticket ${JIRA_TICKET} to 'In Progress'...`);
      ...
      if (!transitionsRes.ok)
        throw new Error(`Failed to fetch Jira transitions: ${transitionsRes.status} ${transitionsRes.statusText}`);
    ...
    console.log(`\u{1F389} Pull Request created from '${branchName}' to 'develop'`);
    console.log(`\u2705 You are now on branch '${branchName}' with initial commit pushed`);
    console.log(`\u{1F517} The PR is ready on GitHub`);
